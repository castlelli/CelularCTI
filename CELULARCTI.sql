...
CREATE TABLE cliente(
    id_cliente bigserial NOT NULL PRIMARY KEY,   -- campo identity  autoincremento
...
insert into cliente (nome, telefone, email, login, senha) values ('Maria da Silva', '(14) 98762-2323', 'maria@uol.com.br', 'maria','123');
insert into cliente (nome, telefone, email, login, senha) values ('Carlos Antonio', '(14) 98765-3545', 'carlos@gmail.com', 'carlos', '123');
insert into cliente (nome, telefone, email, login, senha) values ('Silvio Santos', '(14) 99854-7898', 'silvio@gmail.com', 'silvio', '123');
insert into cliente (nome, telefone, email, login, senha) values ('Luiza Santos', '(14) 93333-5455', 'luiza@uol.com.br', 'luiza', '123');
